...
# Database: proj_news
# Generation Time: 2021-11-18 12:16:32 +0000
# ************************************************************
...
INSERT INTO `article` (`id`, `category_id`, `name`, `content`, `status`, `thumb`, `created`, `created_by`, `modified`, `modified_by`, `publish_at`, `type`)
VALUES
...
INSERT INTO `category` (`id`, `name`, `status`, `created`, `created_by`, `modified`, `modified_by`, `is_home`, `display`, `menu_id`)
VALUES
	(1,'Thể thao','active','2019-05-04 00:00:00','admin','2019-05-12 00:00:00','hailan',1,'list',3),
	(2,'Giáo dục','active','2019-05-04 00:00:00','admin','2019-05-12 00:00:00','hailan',1,'grid',3),
	(3,'Sức khỏe','active','2019-05-04 00:00:00','admin','2019-05-15 15:04:33','hailan',1,'list',3),
	(4,'Du lịch','active','2019-05-04 00:00:00','admin','2019-05-15 15:04:30','hailan',1,'list',3),
	(5,'Khoa học','active','2019-05-04 00:00:00','admin','2019-05-12 00:00:00','hailan',1,'list',1),
	(6,'Số hóa','active','2019-05-04 00:00:00','admin','2021-08-17 14:08:57','hailan',1,'grid',1),
	(7,'Xe - Ô tô','active','2019-05-04 00:00:00','admin','2021-08-17 14:08:56','hailan',1,'3',3),
	(8,'Kinh doanh','active','2019-05-12 00:00:00','hailan','2021-08-17 14:08:55',NULL,1,'3',1),
	(9,'Jessica James','active','2021-11-13 00:00:00','hailan','2021-11-13 00:00:00','hailan',NULL,NULL,3);
...
CREATE TABLE `menus` (
  ...
  `type_open` enum('current','new_tab') COLLATE utf8mb4_unicode_ci NOT NULL,
  `link` varchar(255) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `slug` varchar(255) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `is_category` tinyint(11) DEFAULT NULL,
  `created_by` varchar(255) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `created` timestamp NULL DEFAULT NULL,
  `modified_by` varchar(11) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
...
INSERT INTO `menus` (`id`, `name`, `status`, `order`, `type_open`, `link`, `slug`, `is_category`, `created_by`, `created`, `modified_by`, `modified`)
VALUES
	(1,'Menu - 1','inactive',1,'new_tab','https://laravelcollective.com/docs/6.x/html#number',NULL,NULL,'hailan','2021-11-10 00:00:00','hailan','2021-11-13 00:00:00'),
	(3,'Menu - 2','inactive',0,'new_tab','https://laravelcollective.com/docs/6.x/html#number',NULL,NULL,'hailan','2021-11-10 00:00:00','hailan','2021-11-15 00:00:00');
...
VALUES
	(1,'2021_08_20_075059_create_tags_table',1),
	(2,'2021_08_20_075220_create_artilce_tags_table',1),
	...
	(12,'2021_11_09_155552_create_menu_table',5);
...
INSERT INTO `rss` (`id`, `name`, `status`, `link`, `ordering`, `source`, `created`, `created_by`, `modified`, `modified_by`)
VALUES
	(2,'Thế Giới TuoiTre','active','https://tuoitre.vn/rss/the-gioi.rss',2,'tuoitre','2021-07-11 00:00:00','hailan','2021-11-01 12:08:05',NULL),
	(4,'Thời sự VNEx','active','https://vnexpress.net/rss/thoi-su.rss',4,'vnexpress','2021-07-12 00:00:00','hailan','2021-08-23 04:20:56','hailan'),
	(5,'Tin Xem Nhiều Vnexpress','active','https://vnexpress.net/rss/tin-xem-nhieu.rss',1,'vnexpress','2021-08-22 00:00:00','hailan','2021-11-01 12:08:04',NULL);
...
INSERT INTO `setting` (`id`, `key_value`, `value`)
VALUES
	(5,'setting-generate','{\"hotline\":\"0707039495\",\"time_work\":\"1234\",\"copyright\":\"Adipisci odio in iur\",\"address\":\"Asperiores tempor eu\",\"introduce\":\"<p>123123123123<\\/p>\\r\\n\\r\\n<p>&nbsp;<\\/p>\",\"googlemap\":\"<iframe src=\\\"https:\\/\\/www.google.com\\/maps\\/embed?pb=!1m18!1m12!1m3!1d3919.3257202625227!2d106.69037385111042!3d10.786345992277074!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x31752f2f20ed1c49%3A0x5781806fe59379f4!2zQ8O0bmcgVHkgQ-G7lSBQaOG6p24gTOG6rXAgVHLDrG5oIFplbmQgVmnhu4d0IE5hbQ!5e0!3m2!1svi!2s!4v1578582210228!5m2!1svi!2s\\\"\\r\\n        width=\\\"600\\\" height=\\\"600\\\" frameborder=\\\"0\\\" style=\\\"border:0;\\\"\\r\\n        allowfullscreen=\\\"\\\"><\\/iframe>\",\"logo\":\"86RaEkPbvh.png\"}'),
	(6,'setting-email','{\"email\":\"huxaviha@mailinator.com\",\"password\":\"Ut blanditiis velit \",\"bcc\":\"[{\\\"value\\\":\\\"hainguyenhai0@gmail.com\\\"},{\\\"value\\\":\\\"hai@gmail.com\\\"}]\"}'),
	(7,'setting-social','{\"facebook\":\"[{\\\"value\\\":\\\"https:\\/\\/www.facebook.com\\/\\\"}]\",\"youtube\":\"[{\\\"value\\\":\\\"https:\\/\\/www.youtube.com\\/watch?v=k40MZMznjlo&t=10s\\\"}]\",\"google\":\"[{\\\"value\\\":\\\"https:\\/\\/www.google.com\\/\\\"}]\"}');
...
INSERT INTO `slider` (`id`, `name`, `description`, `link`, `thumb`, `created`, `created_by`, `modified`, `modified_by`, `status`)
VALUES
	...
	(3,'Ưu đãi học phí','Tổng hợp các trương trình ưu đãi học phí hàng tuần, hàng tháng đến tất các các bạn với các mức giảm đặc biệt 50%, 70%,..','https://zendvn.com/uu-dai-hoc-phi-tai-zendvn/','LWi6hINpXz.jpeg','2019-04-24 00:00:00','hailan','2021-05-07 00:00:00','hailan','active');
...
INSERT INTO `user` (`id`, `username`, `email`, `fullname`, `password`, `avatar`, `level`, `created`, `created_by`, `modified`, `modified_by`, `status`)
VALUES
	(1,'admin','admin@gmail.com','test','e10adc3949ba59abbe56e057f20f883e','1ctW8mj8vq.png','admin','2014-12-10 08:55:35','admin','2019-05-04 14:47:14','hailan','active'),
	(2,'hailan123','hailan@gmail.com','hailan','d41d8cd98f00b204e9800998ecf8427e','1eSGmvZ3gM.jpeg','admin','2014-12-13 07:20:03','admin','2021-11-08 00:00:00','hailan','active'),
	(3,'user123','test@gmail.com','test123','d41d8cd98f00b204e9800998ecf8427e','E81Yprpp6J.png','admin','2019-05-04 00:00:00','admin','2021-11-17 00:00:00','hailan','active'),
	(4,'user456','user456@gmail.com','user456','d41d8cd98f00b204e9800998ecf8427e','FioVAG0Mnr.png','admin','2019-05-04 00:00:00','admin','2021-05-06 00:00:00','hailan','active'),
	(5,'hainguyen1','hainguyen@t2gcorp.com','hai123','70a0f9894d2df18c2507d231a94caee8','ei4ZnI0E6r.png','admin','2021-11-08 00:00:00','hailan','2021-11-17 00:00:00','hailan','active');
